...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long locRowId = prepareDBwithLocation();
        ...
        TestUtilities.validateCurrentRecord("ERR: LOC QUERY VALID> FAILED", cursor, testValues);
        assertFalse("ERR: MORE THAN ONE RECORD RETURNED FROM LOC QUERY", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        long locationId = prepareDBwithLocation();
        ...
        // Move the cursor to a valid database row
        assertTrue("NO WEATHER RECORDS", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("ERR: WEATHER QUERY VALID> FAILED", cursor, weatherValues);
     ...
     */
    public long prepareDBwithLocation() {
